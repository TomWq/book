...
export default async function WritingStatsPage() {
  ...
  return (
    <div className="writing-stats-page">
      ...
      <Panel
        title="创作日历"
        description="按正文草稿生成日期统计最近 35 天字数。"
        action={
      ...
      >
        ...
        <div className="writing-calendar-grid expanded" aria-label="最近 35 天创作字数">
          {calendarDays.map((date) => {
            ...
            return (
              ...
              >
                ...
                <strong>{characters > 0 ? characters.toLocaleString("zh-CN") : ""}</strong>
              </div>
            );
          })}
        </div>
